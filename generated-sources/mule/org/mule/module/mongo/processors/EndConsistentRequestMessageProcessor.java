...
/**
 * EndConsistentRequestMessageProcessor invokes the {@link org.mule.module.mongo.MongoCloudConnector#endConsistentRequest()} method in {@link MongoCloudConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-RC1", date = "2014-05-08T10:05:29-05:00", comments = "Build master.1926.b0106b2")
public class EndConsistentRequestMessageProcessor
    extends AbstractConnectedProcessor
    implements MessageProcessor
{


    public EndConsistentRequestMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((MongoCloudConnector) object).endConsistentRequest();
                    return null;
                }
