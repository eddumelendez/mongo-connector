...
/**
 * FindObjectsUsingQueryMapMessageProcessor invokes the {@link org.mule.module.mongo.MongoCloudConnector#findObjectsUsingQueryMap(java.lang.String, java.util.Map, java.util.List, java.lang.Integer, java.lang.Integer)} method in {@link MongoCloudConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((MongoCloudConnector) object).findObjectsUsingQueryMap(_transformedCollection, _transformedQueryAttributes, _transformedFields, _transformedNumToSkip, _transformedLimit);
                }
