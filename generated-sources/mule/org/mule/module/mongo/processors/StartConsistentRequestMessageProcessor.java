...
/**
 * StartConsistentRequestMessageProcessor invokes the {@link org.mule.module.mongo.MongoCloudConnector#startConsistentRequest()} method in {@link MongoCloudConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-RC1", date = "2014-05-05T02:17:19-05:00", comments = "Build master.1926.b0106b2")
public class StartConsistentRequestMessageProcessor
    extends AbstractConnectedProcessor
    implements MessageProcessor
{


    public StartConsistentRequestMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((MongoCloudConnector) object).startConsistentRequest();
                    return null;
                }
