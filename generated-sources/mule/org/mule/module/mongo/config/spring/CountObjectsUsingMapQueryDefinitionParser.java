...
import org.mule.module.mongo.config.CountObjectsUsingMapQueryMessageProcessor;
...
public class CountObjectsUsingMapQueryDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public CountObjectsUsingMapQueryDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CountObjectsUsingMapQueryMessageProcessor.class.getName());
