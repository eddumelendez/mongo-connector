...
import org.mule.module.mongo.config.FindObjectsUsingQueryMapMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public FindObjectsUsingQueryMapDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(FindObjectsUsingQueryMapMessageProcessor.class.getName());
