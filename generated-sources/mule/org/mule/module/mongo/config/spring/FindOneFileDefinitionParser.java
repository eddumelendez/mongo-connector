...
import org.mule.module.mongo.config.FindOneFileMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public FindOneFileDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(FindOneFileMessageProcessor.class.getName());
