...
import org.mule.module.mongo.config.ListFilesMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public ListFilesDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(ListFilesMessageProcessor.class.getName());
