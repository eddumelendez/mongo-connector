...
import org.mule.module.mongo.config.CreateFileFromPayloadMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public CreateFileFromPayloadDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CreateFileFromPayloadMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("metadata-ref")!= null)&&(!StringUtils.isBlank(element.getAttribute("metadata-ref")))) {
