    ...
    implements BeanDefinitionParser
{
    ...
    public CreateIndexDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CreateIndexMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("field")!= null)&&(!StringUtils.isBlank(element.getAttribute("field")))) {
