...
import org.mule.module.mongo.config.FindFilesMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public FindFilesDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(FindFilesMessageProcessor.class.getName());
