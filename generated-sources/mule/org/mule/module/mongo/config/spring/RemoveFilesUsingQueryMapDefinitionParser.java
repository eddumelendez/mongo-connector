...
import org.mule.module.mongo.config.RemoveFilesUsingQueryMapMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public RemoveFilesUsingQueryMapDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(RemoveFilesUsingQueryMapMessageProcessor.class.getName());
