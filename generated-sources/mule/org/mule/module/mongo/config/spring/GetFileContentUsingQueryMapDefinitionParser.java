...
import org.mule.module.mongo.config.GetFileContentUsingQueryMapMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public GetFileContentUsingQueryMapDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetFileContentUsingQueryMapMessageProcessor.class.getName());
