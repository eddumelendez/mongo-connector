    ...
    implements BeanDefinitionParser
{
    ...
    public MapReduceObjectsDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(MapReduceObjectsMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("mapFunction")!= null)&&(!StringUtils.isBlank(element.getAttribute("mapFunction")))) {
            builder.addPropertyValue("mapFunction", element.getAttribute("mapFunction"));
        }
        if ((element.getAttribute("reduceFunction")!= null)&&(!StringUtils.isBlank(element.getAttribute("reduceFunction")))) {
            builder.addPropertyValue("reduceFunction", element.getAttribute("reduceFunction"));
        }
        if ((element.getAttribute("outputCollection")!= null)&&(!StringUtils.isBlank(element.getAttribute("outputCollection")))) {
            builder.addPropertyValue("outputCollection", element.getAttribute("outputCollection"));
        }
