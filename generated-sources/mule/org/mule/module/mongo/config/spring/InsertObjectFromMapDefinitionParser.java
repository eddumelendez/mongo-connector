...
import org.mule.module.mongo.config.InsertObjectFromMapMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public InsertObjectFromMapDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(InsertObjectFromMapMessageProcessor.class.getName());
