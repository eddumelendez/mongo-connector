...
import org.mule.module.mongo.config.RemoveUsingMapQueryMessageProcessor;
...
public class RemoveUsingMapQueryDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public RemoveUsingMapQueryDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(RemoveUsingMapQueryMessageProcessor.class.getName());
