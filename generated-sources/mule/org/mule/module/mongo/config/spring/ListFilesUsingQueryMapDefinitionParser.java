...
import org.mule.module.mongo.config.ListFilesUsingQueryMapMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public ListFilesUsingQueryMapDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(ListFilesUsingQueryMapMessageProcessor.class.getName());
