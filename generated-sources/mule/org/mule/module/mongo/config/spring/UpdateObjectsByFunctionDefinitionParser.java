...
import org.mule.module.mongo.config.UpdateObjectsByFunctionMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public UpdateObjectsByFunctionDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(UpdateObjectsByFunctionMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("function")!= null)&&(!StringUtils.isBlank(element.getAttribute("function")))) {
            builder.addPropertyValue("function", element.getAttribute("function"));
        }
        ...
        if ((element.getAttribute("upsert")!= null)&&(!StringUtils.isBlank(element.getAttribute("upsert")))) {
            builder.addPropertyValue("upsert", element.getAttribute("upsert"));
        }
        if ((element.getAttribute("multi")!= null)&&(!StringUtils.isBlank(element.getAttribute("multi")))) {
            builder.addPropertyValue("multi", element.getAttribute("multi"));
        }
