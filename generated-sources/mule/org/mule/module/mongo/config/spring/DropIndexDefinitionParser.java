    ...
    implements BeanDefinitionParser
{
    ...
    public DropIndexDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(DropIndexMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("index")!= null)&&(!StringUtils.isBlank(element.getAttribute("index")))) {
