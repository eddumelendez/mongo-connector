...
import org.mule.module.mongo.config.FindFilesUsingQueryMapMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public FindFilesUsingQueryMapDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(FindFilesUsingQueryMapMessageProcessor.class.getName());
