    ...
    implements BeanDefinitionParser
{
    ...
    public InsertObjectDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(InsertObjectMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("dbObject-ref")!= null)&&(!StringUtils.isBlank(element.getAttribute("dbObject-ref")))) {
