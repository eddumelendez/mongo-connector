...
import org.mule.module.mongo.config.RemoveFilesMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public RemoveFilesDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(RemoveFilesMessageProcessor.class.getName());
