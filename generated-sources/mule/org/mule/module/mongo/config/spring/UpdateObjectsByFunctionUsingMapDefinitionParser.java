...
import org.mule.module.mongo.config.UpdateObjectsByFunctionUsingMapMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public UpdateObjectsByFunctionUsingMapDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(UpdateObjectsByFunctionUsingMapMessageProcessor.class.getName());
