...
import org.mule.module.mongo.config.UpdateObjectsUsingMapMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public UpdateObjectsUsingMapDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(UpdateObjectsUsingMapMessageProcessor.class.getName());
