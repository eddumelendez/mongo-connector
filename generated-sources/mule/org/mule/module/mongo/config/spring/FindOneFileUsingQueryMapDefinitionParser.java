...
import org.mule.module.mongo.config.FindOneFileUsingQueryMapMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public FindOneFileUsingQueryMapDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(FindOneFileUsingQueryMapMessageProcessor.class.getName());
