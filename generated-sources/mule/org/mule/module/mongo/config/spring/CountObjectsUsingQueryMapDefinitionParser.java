...
import org.mule.module.mongo.config.CountObjectsUsingQueryMapMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public CountObjectsUsingQueryMapDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CountObjectsUsingQueryMapMessageProcessor.class.getName());
