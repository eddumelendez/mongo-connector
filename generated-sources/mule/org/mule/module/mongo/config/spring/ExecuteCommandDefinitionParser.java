...
import org.mule.module.mongo.config.ExecuteCommandMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public ExecuteCommandDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(ExecuteCommandMessageProcessor.class.getName());
        String configRef = element.getAttribute("config-ref");
        if ((configRef!= null)&&(!StringUtils.isBlank(configRef))) {
            builder.addPropertyValue("moduleObject", configRef);
        }
        if ((element.getAttribute("commandName")!= null)&&(!StringUtils.isBlank(element.getAttribute("commandName")))) {
            builder.addPropertyValue("commandName", element.getAttribute("commandName"));
        }
        if ((element.getAttribute("commandValue")!= null)&&(!StringUtils.isBlank(element.getAttribute("commandValue")))) {
            builder.addPropertyValue("commandValue", element.getAttribute("commandValue"));
        }
