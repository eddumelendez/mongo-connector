...
public class MongoCloudConnectorConnectionManager
    implements Capabilities, ConnectionManager<MongoCloudConnectorConnectionManager.ConnectionParameters, MongoCloudConnectorLifecycleAdapter> , Initialisable
{
    ...
    public MongoCloudConnectorLifecycleAdapter acquireConnection(MongoCloudConnectorConnectionManager.ConnectionParameters key)
        throws Exception
    {
        return ((MongoCloudConnectorLifecycleAdapter) connectionPool.borrowObject(key));
    }

    public void releaseConnection(MongoCloudConnectorConnectionManager.ConnectionParameters key, MongoCloudConnectorLifecycleAdapter connection)
        throws Exception
    {
        connectionPool.returnObject(key, connection);
    }

    public void destroyConnection(MongoCloudConnectorConnectionManager.ConnectionParameters key, MongoCloudConnectorLifecycleAdapter connection)
        throws Exception
    {
        ...
        implements KeyedPoolableObjectFactory
    {
        ...
        public Object makeObject(Object key)
            throws Exception
        {
            if (!(key instanceof MongoCloudConnectorConnectionManager.ConnectionParameters)) {
            ...
            throws Exception
        {
            ...
            try {
                if (!((MongoCloudConnectorLifecycleAdapter) obj).isConnected()) {
                    ((MongoCloudConnectorLifecycleAdapter) obj).connect(((MongoCloudConnectorConnectionManager.ConnectionParameters) key).getUsername(), ((MongoCloudConnectorConnectionManager.ConnectionParameters) key).getPassword());
                }
            } catch (Exception e) {
                throw e;
            }
    ...
    public static class ConnectionParameters {
        ...
        public boolean equals(Object obj) {
            return ((obj instanceof MongoCloudConnectorConnectionManager.ConnectionParameters)&&(this.username == ((MongoCloudConnectorConnectionManager.ConnectionParameters) obj).username));
        }
